  ...
  computed: {
    ...
    data() {
      ...
      if (this.chartData.c.length > 0) {
        let n = new Decimal(0);
        result.push([{
          x: new Decimal(this.chartData.c[0]).minus(
            this.chartData.c[1] - this.chartData.c[0],
          ),
          y: 0,
        }, {
        ...
        result.push([{
          ...
          x: new Decimal(this.chartData.c[this.chartData.c.length - 1]).plus(
            this.chartData.c[this.chartData.c.length - 1]
            - this.chartData.c[this.chartData.c.length - 2],
          ),
          y: 1,
        }]);
      }
